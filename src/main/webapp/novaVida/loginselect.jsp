...
<section class="welcome-section">
    <div class="welcome-content">
        ...
        <p class="welcome-subtitle">Sua jornada financeira começa aqui. Escolha como deseja acessar nossa
            plataforma.</p>
    </div>
</section>
...
<script src="${pageContext.request.contextPath}/js/loginselect.js">
</script>
</body>
</html>