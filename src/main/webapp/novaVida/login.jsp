...
<div class="login-container">
    ...
    <div class="form-container" id="cliente-form">
        ...
        <form class="login-form" action="${pageContext.request.contextPath}/loginCliente" method="post" style="display: none;">
            <%-- Conteúdo do formulário de login do cliente --%>
    ...
    <div class="form-container" id="funcionario-form">
        ...
        <form class="login-form" action="${pageContext.request.contextPath}/loginFuncionario" method="post" style="display: none;">
            <%-- Conteúdo do formulário de login do funcionário --%>
