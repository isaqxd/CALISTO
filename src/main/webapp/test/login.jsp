...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/test/css/loginstyle.css">
...
<script src="${pageContext.request.contextPath}/test/js/loginscript.js"></script>
