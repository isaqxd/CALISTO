...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Blocos de cada seção (usuário, corporativo, endereço) */
    .form-section {
    ...
    .btn-primary {
      ...
      border: none;
      border-radius: 24px;
      background: linear-gradient(to right, #3b1d10, #5a2c1e);
      color: #fff;
      font-size: 1.1rem;
      cursor: pointer;
...
<div class="app-container">
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      <ul>
        <li><a href="#" data-section="dashboard" class="menu-item active"><span class="menu-icon">📊</span><span>Dashboard</span></a>
        </li>
        ...
        <li><a href="#" data-section="relatorios" class="menu-item"><span
                class="menu-icon">📄</span><span>Relatórios</span></a></li>
        <li><a href="#" data-section="ferramentas" class="menu-item"><span class="menu-icon">🔧</span><span>Ferramentas Internas</span></a>
        </li>
        <li><a href="#" data-section="suporte" class="menu-item"><span
                class="menu-icon">🎧</span><span>Suporte</span></a></li>
        <li><a href="#" data-section="configuracoes" class="menu-item"><span class="menu-icon">⚙️</span><span>Configurações</span></a>
        </li>
      </ul>
    </nav>
  </aside>
