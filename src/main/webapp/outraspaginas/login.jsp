...
<head>
    ...
    <link rel="stylesheet" href="/src/main/webapp/css/login.css">
</head>
<body class="cliente-mode">
            ...
            <div class="login-side cliente-side">
                ...
                <div class="form-section">
                    <form class="login-form" id="clienteForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-container">
                                ...
                                <button type="button" class="password-toggle" onclick="togglePassword('clientePassword')">
                                    <img src="/src/main/webapp/imagens/iconeyeclosed.png" alt="Mostrar senha" id="icon-clientePassword" width="20">
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="toggle-section">
                            <p class="toggle-text">Acesso para funcionários?</p>
                            <button type="button" class="toggle-btn" onclick="location.href='/src/main/webapp/landpage.jsp'">Sair</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-container">
                                ...
                                <button type="button" class="password-toggle" onclick="togglePassword('funcionarioPassword')">
                                    <img src="/src/main/webapp/imagens/iconeyeclosed.png" alt="Mostrar senha" id="icon-funcionarioPassword" width="20">
                                </button>
                            </div>
                        </div>
    ...
    <script src="/src/main/webapp/script/login.js"></script>
</body>
</html>