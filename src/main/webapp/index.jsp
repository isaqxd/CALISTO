...
<header class="header" id="header">
  <div class="nav-container">
    ...
    <div class="nav-actions">
      <a href="novaVida/loginselect.jsp" class="btn-login">Acessar Conta</a>
    </div>
  </div>
</header>
...
<section class="hero" id="home">
  <div class="hero-content">
    ...
    <div class="hero-cta">
      <a href="novaVida/loginselect.jsp" class="btn-primary" onclick="goToLoginPage()">Começar Agora</a>
...
<section class="cta-section fade-in">
  <div class="cta-content">
    ...
    <a href="novaVida/login.jsp" class="btn-cta" onclick="goToLoginPage()">Acessar Minha Conta</a>
  </div>
</section>
