...
function togglePassword(fieldId) {
    ...
    if (field.type === 'password') {
        field.type = 'text';
        icon.src = '/src/main/java/WebContent/imagens/iconeyeclosed.png'; // Ícone para "ocultar senha"
        icon.alt = 'Ocultar senha';
    } else {
        field.type = 'password';
        icon.src = '/src/main/java/WebContent/imagens/iconeyeopen.png'; // Ícone para "mostrar senha"
